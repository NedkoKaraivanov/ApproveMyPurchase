...
public class ExecutiveMeeting extends Approver {
    private static final ExecutiveMeeting INSTANCE = new ExecutiveMeeting(0, 0, 0, 0, 0);

    public ExecutiveMeeting(Integer consumableLimit, Integer clericalLimit, Integer gadgetsLimit, Integer gamingLimit, Integer pcLimit) {
